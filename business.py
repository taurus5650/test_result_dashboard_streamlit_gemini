...
class Business:
    ...
    def get_failure_summary_grouped_by_service(self, start_date: str, end_date: str):
        sql = ("""
            SELECT service_team, COUNT(*) AS fail_count
            FROM automation_test_result, jsonb_array_elements(failure_records) AS failed_case
