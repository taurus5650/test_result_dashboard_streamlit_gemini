...
class GeminiHelper:
    ...
    def _make_cache_key(self, service_team: str, error_list: list[str], date: str) -> str:
        # Only keep top 30 errors to control prompt size and avoid token limit issues
        error_list = sorted(set(error_list))[:30]
    ...
    def anlayze_failure_reason(self, service_team: str, error_list: list[str], date: str) -> dict:
        ...
        prompt = f"""
            You are an expert Software Quality Assurance.
